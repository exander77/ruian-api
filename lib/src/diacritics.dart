...
abstract class Diacritics {
  static String removeDiacritics(String text) => new String.fromCharCodes(replaceCodeUnits(text.codeUnits));

  static List<int> replaceCodeUnits(List<int> codeUnits) {
    _initIfRequired();
    final result = <int>[];
